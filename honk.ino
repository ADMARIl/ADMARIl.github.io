...
int ledToggle(String command) {
    ...
    */
    ...
    if (command=="long") {
        ...
        // trigger the horn to the tune of the mario "overworld" theme
        Particle.publish("HJONK", "hj");
        digitalWrite(led2, HIGH);
        int onLengths[] ={100,100,150,100,100,150,150};
        int offLengths[] = {50,200,150,50,200,350,0};
        // hjonk the horn!
        for (int i = 0; i < 7; i++) {
            digitalWrite(led2, LOW);
            delay(onLengths[i]*10);
            digitalWrite(led2, HIGH);
            delay(offLengths[i]*10);
        }
        digitalWrite(led2, HIGH);
        return 2;
    }
